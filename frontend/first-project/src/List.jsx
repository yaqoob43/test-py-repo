  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-[#0d0d1a] via-[#1a1a2f] to-[#0d0d1a] px-6 py-16 animate-gradient-xy text-white">
      <div className="max-w-3xl mx-auto space-y-12">
        {/* Main Heading */}
        <h2 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-purple-500 animate-pulse">
          Movies Manager
        </h2>
...
<div className="flex flex-col gap-4">
  <div className="flex flex-col md:flex-row gap-4">
    <input
      ...
      className="flex-1 px-5 py-3 rounded-2xl bg-white/10 backdrop-blur-lg border border-purple-600/20 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-purple-500 transition"
    />
  ...
  >
    Add Movie
        ...
        {/* Movies List */}
        <h3 className="text-2xl font-semibold text-white/90">All Movies</h3>
          ...
          {movies.map((movie) => (
            <div
              ...
              className="bg-white/10 backdrop-blur-3xl border border-purple-600/20
                  ...
                  hover:translate-x-1 hover:shadow-[0_15px_50px_rgba(128,0,128,0.4)]"
            >
              <div className="space-y-1">
                <h4 className="text-lg font-bold bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent animate-pulse">
                  {movie.title}
                </h4>
                ...
                <p className="text-sm text-white/70">
                  <span className="text-white font-medium">Rating:</span> {movie.rating}
                </p>
              </div>
              <button
